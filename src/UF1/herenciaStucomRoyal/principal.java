...
public class principal {
    ...
    private static fichero miFicheroCartas;

    static listaJugador miJuego;
    static listaCartas miCarta;

    public principal() {


        miFichero = new fichero("juego.xml");
        miFicheroCartas = new fichero("baraja.xml");

        miJuego =(listaJugador) miFichero.read();
        miCarta = (listaCartas) miFicheroCartas.read();

        if (miJuego == null) {
            miJuego = new listaJugador();
            miCarta = new listaCartas();
            ...
            miFicheroCartas.grabar(miCarta);
        }
